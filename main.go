...
func generateInstallationToken() string {
	...
	url := "https://api.github.com/app/installations/64582855/access_tokens"
...
func main() {
	...
	url := "https://api.github.com/repos/aliculPix4D/test-gh-status-app/commits/master/statuses"
